...
public final class BiomeResourceProfiles {
    private static final Map<String, BiomeResourceProfile> PROFILES = Map.ofEntries(
            ...
            entry(profile(
                    ...
                    Set.of(Blocks.COAL_ORE, Blocks.COPPER_ORE, Blocks.IRON_ORE, Blocks.GOLD_ORE, Blocks.RUBY_ORE, Blocks.SAPPHIRE_ORE, Blocks.GLOW_CRYSTAL_NODE),
            ...
            entry(profile(
                    ...
                    Set.of(Blocks.COAL_ORE, Blocks.COPPER_ORE, Blocks.IRON_ORE, Blocks.GOLD_ORE, Blocks.TITAN_ORE),
                    List.of("voxel:watchtower", "voxel:small_ruin"),
                    List.of("voxel:forest_bunny", "voxel:little_boar"),
            ...
            entry(profile(
                    "voxel:frost_peaks",
                    Set.of(Blocks.SNOW, Blocks.SNOWY_GRASS, Blocks.GRAVEL, Blocks.ICE, Blocks.STONE),
                    Set.of(Blocks.SMALL_STONE),
                    Set.of(Blocks.SNOW, Blocks.SNOWY_GRASS, Blocks.ICE, Blocks.SMALL_STONE, Blocks.GLOW_CRYSTAL_NODE),
                    Set.of(Blocks.COAL_ORE, Blocks.COPPER_ORE, Blocks.SAPPHIRE_ORE, Blocks.PLATIN_ORE, Blocks.GLOW_CRYSTAL_NODE),
                    List.of("voxel:small_ruin"),
            ...
            entry(profile(
                    "voxel:sun_dunes",
                    Set.of(Blocks.SAND, Blocks.RED_SAND, Blocks.STONE),
                    Set.of(Blocks.CACTUS),
                    Set.of(Blocks.SMALL_STONE, Blocks.CACTUS, Blocks.RED_SAND),
                    Set.of(Blocks.COAL_ORE, Blocks.COPPER_ORE, Blocks.GOLD_ORE),
