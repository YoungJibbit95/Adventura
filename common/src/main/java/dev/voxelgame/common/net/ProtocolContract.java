...
public final class ProtocolContract {
    ...
    static {
        ...
        register(PacketType.SERVER_STATS_SNAPSHOT, Direction.SERVER_TO_CLIENT, Authority.SERVER_TELEMETRY, TrustLevel.SERVER_CONFIRMED, "diagnostic tick", 128, SaveReplayRelevance.NONE, "Debug/diagnostic network counters.");
